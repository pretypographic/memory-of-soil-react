...
import { MemoryRing } from '../MemoryRing/MemoryRing';
import { MemoryWave } from '../MemoryWave/MemoryWave';

function Pensieve({ generateAnimationStyles, clearAnimationStyles, executeBlackOut }) {
